...
Questa settimana ho approfondito le aggregazioni e l'uso di funzioni integrate e viste in SQL. Ho imparato a sintetizzare grandi quantità di dati con `GROUP BY`, filtrare i gruppi con `HAVING`, e costruire viste permanenti per analisi e reportistica (Excel / Power BI).
...
Ho capito come passare da semplici query a modelli di analisi completi: dall'aggregazione dei dati fino alla creazione di viste strutturate e report Excel. È stata la prima vera introduzione all'analisi dati con approccio "BI-ready".

---

# Week 7 — Aggregations, Built-in Functions and Views in SQL

This week focused on data aggregation, built-in functions, and views in SQL. I learned to summarize large datasets using `GROUP BY` and `HAVING`, and to design reusable SQL views for analytical tools like Excel and Power BI.
...
- PK checks on DimProduct and FactResellerSales
- Grouping and aggregations with `GROUP BY` and `HAVING`
- Revenue calculations by product, category, and city
- Practical application of aggregation functions

### W7D4 – Practice

- Creation of Product, Reseller, Sales views
- Exposing key fields for logical relationships in Excel
- Analysis of sales, quantities, and profits by product and reseller
- Using views as data sources for Power Pivot

## Highlight

Learning to structure SQL for reporting — not just querying — was the key step toward understanding data modeling and business intelligence workflows.
